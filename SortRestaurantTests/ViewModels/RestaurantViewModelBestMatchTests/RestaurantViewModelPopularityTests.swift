...
class RestaurantViewModelPopularityTests: XCTestCase {

    let defaultSort = RestaurantSort("Popularity",PopularitySort())
    ...
    func testPopularity_GroupedByOpenOrderCloseAndSorted() {
        ...
        waitForExpectations(timeout: 1) { error in
            ...
            XCTAssertTrue(viewModel[0].sort.popularity >= viewModel[1].sort.popularity)
            
            XCTAssertTrue(viewModel[2].status == .order)
            XCTAssertTrue(viewModel[3].status == .order)
            XCTAssertTrue(viewModel[2].sort.popularity >= viewModel[3].sort.popularity)
            
            XCTAssertTrue(viewModel[4].status == .close)
            XCTAssertTrue(viewModel[5].status == .close)
            XCTAssertTrue(viewModel[4].sort.popularity >= viewModel[5].sort.popularity)
            
        }
    }
    
    func testPopularity_GroupedByOrderCloseAndSorted() {
    ...
    func testPopularity_GroupedByOpenCloseAndSorted() {
    ...
    func testPopularity_GroupedByOpenOrderAndSorted() {
    ...
    func testPopularity_GroupedByFavouritesAndOpenOrderCloseAndSorted() {
